class TicGame {
    ...
    gameEnded(){
        ...
        for(var i = 0;i < 3; i++){
            rows[0].cells[i].childNodes[0].disabled = true;
        }
        for(var i = 0;i < 3; i++){
            rows[1].cells[i].childNodes[0].disabled = true;
        }
        for(var i = 0;i < 3; i++){
            rows[2].cells[i].childNodes[0].disabled = true; 
        }
    }
    ...
    winnerCheck(){
       ...
       var resultArray = []
        for(var i = 0;i < 3; i++){
            resultArray.push(rows[0].cells[i].childNodes[0].innerText)       
        }
        for(var i = 0;i < 3; i++){
            resultArray.push(rows[1].cells[i].childNodes[0].innerText)          
        }
        for(var i = 0;i < 3; i++){
            resultArray.push(rows[2].cells[i].childNodes[0].innerText)       
        }
        //FOR X WINNER
        if(resultArray[0] === "X" &&  resultArray[1] === "X" && resultArray[2] === "X" )
        {return false}
        if(resultArray[3] === "X" &&  resultArray[4] === "X" && resultArray[5] === "X" )
        {return false}
        if(resultArray[6] === "X" &&  resultArray[7] === "X" && resultArray[8] === "X" )
        {return false}
        if(resultArray[0] === "X" &&  resultArray[4] === "X" && resultArray[8] === "X" )
        {return false}
        if(resultArray[2] === "X" &&  resultArray[4] === "X" && resultArray[6] === "X" )
        {return false}
        if(resultArray[0] === "X" &&  resultArray[3] === "X" && resultArray[6] === "X" )
        {return false}
        if(resultArray[1] === "X" &&  resultArray[4] === "X" && resultArray[7] === "X" )
        {return false}
        //FOR O WINNER
        if(resultArray[0] === "O" &&  resultArray[1] === "O" && resultArray[2] === "O" )
        {return true}
        if(resultArray[3] === "O" &&  resultArray[4] === "O" && resultArray[5] === "O" )
        {return true}
        if(resultArray[6] === "O" &&  resultArray[7] === "O" && resultArray[8] === "O" )
        {return true}
        if(resultArray[0] === "O" &&  resultArray[4] === "O" && resultArray[8] === "O" )
        {return true}
        if(resultArray[2] === "O" &&  resultArray[4] === "O" && resultArray[6] === "O" )
        {return true}
        if(resultArray[0] === "O" &&  resultArray[3] === "O" && resultArray[6] === "O" )
        {return true}
        if(resultArray[1] === "O" &&  resultArray[4] === "O" && resultArray[7] === "O" )
        {return true}
